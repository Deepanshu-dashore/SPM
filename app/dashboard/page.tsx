    ...
    <div className="space-y-12">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between border-b border-white/5 pb-8 gap-6">
        ...
        <Link 
          ...
          className="flex items-center justify-center gap-2 px-6 py-4 sm:py-3 bg-white text-black hover:bg-neutral-200 text-sm font-bold rounded-2xl transition-all duration-300 shadow-xl w-full sm:w-auto"
        >
